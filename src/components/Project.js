    ...
    <Carousel fade className="portBox">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p>
            A platform where collectors of the popular trading card game, Magic:
            The Gathering can advertise, connect, and coordinate trades.
          </p>
          ...
          <div className="mb-2 buttonBar">
            <>
              ...
              <Button
                variant="port"
                href=" https://immense-garden-06811.herokuapp.com"
                size="md"
              >
                Try The App
              </Button>{" "}
              <Button
                variant="port"
                href="https://github.com/MaxFrank13/MtG-Trading-Block"
                size="md"
              >
                See The Code
              </Button>{" "}
        ...
        <Carousel.Caption>
          ...
          <div className="mb-2 buttonBar">
            <>
              ...
              <Button
                variant="port"
                href="https://boiling-reaches-95982.herokuapp.com/profile"
                size="md"
              >
                Try The App
              </Button>{" "}
              <Button
                variant="port"
                href="https://github.com/aaburzak/trivia-challenge"
                size="md"
              >
                See The Code
              </Button>{" "}
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h4>Movie Review</h4>
          <p>
            A simple client side application that allows fans of cinema to look
            up movies and their corresponding reviews
          </p>
          <div className="mb-2 buttonBar">
            <>
              <style type="text/css">
              ...
              <Button
                variant="port"
                href="https://aguasvivasjc.github.io/Cinema-Buff/"
                size="md"
              >
                Try The App
              </Button>{" "}
              <Button
                variant="port"
                href="https://github.com/aguasvivasjc/Cinema-Buff"
                size="md"
              >
                See The Code
              </Button>{" "}
