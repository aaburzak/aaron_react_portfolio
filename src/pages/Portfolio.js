    ...
    return(
      ...
      <Row className="picRow">
        ...
        <Row className="justify-content-md-center botRow">
          ...
          <p>
          You can find more of my developmental work, both collaborative and independent, by visiting my <a className="linkStyle"  href="https://github.com/aaburzak">gitHub</a>, and more on my past professional experience by reviewing my <a className="linkStyle" href="https://www.linkedin.com/in/aaron-burzak-53187654/">Linkedin</a> or <a className="linkStyle" href="/resume">resume</a>.</p>
